...
const _FOCUS_POINTS_RAW: FocusPoint[] = [
  ...
  {
    id: "fp-supply",
    type: "Критическое изменение",
    area: "Контрагенты и поставки",
    state: "Требует решения сейчас",
    tone: "warning",
    title: "Три поставщика одновременно оказались на грани дефолта",
    short: "Три поставщика внесены в реестр банкротств за четыре часа. Под угрозой договоры на 84 млн ₽.",
    missing: "Нет номенклатуры продукции трёх поставщиков, данных о критичности позиций, складских остатках и сроках перехода на альтернативных контрагентов.",
    cta: "Начать подготовку исков",
    impact: "сильное",
    impactTone: "strong",
    confidence: "высокая",
    situation: "Три поставщика внесены в реестр банкротств в 04:35, 06:12 и 07:50. Под угрозой неисполнения находятся три договора на общую сумму 84 млн ₽. Прекращение поставок вероятно в ближайшие недели.",
    cause: "У двух поставщиков незадолго до банкротства сменились собственники. Близкие даты событий и найденные связи между контрагентами могут указывать на согласованный вывод активов. Этот вывод ещё требует проверки.",
    businessImpact: "Компания одновременно сталкивается с правовым и операционным риском: необходимо успеть предъявить требования и попасть в реестр кредиторов, а также не допустить дефицита товаров при прекращении поставок. Мера «Лимит на одного поставщика» сработала лишь частично: ни один контрагент не превышал индивидуальный лимит, но мера не учитывает одновременный дефолт нескольких поставщиков одной категории — её нужно дополнить контролем совокупной зависимости, а не отменять.",
    recommendations: [
      {
        stage: "Сейчас",
        action: "Инициировать подготовку исковых требований по трём договорам на 84 млн ₽ и определить предварительную правовую позицию.",
        expectedEffect: "Компания успеет попасть в реестр кредиторов и сохранит шанс возврата средств по договорам.",
      },
      {
        stage: "Параллельно",
        action: "Определить товары и объём закупок, зависящие от трёх поставщиков, проверить текущие складские остатки.",
        expectedEffect: "Появится оценка операционного разрыва и приоритетов по замене номенклатуры.",
      },
      {
        stage: "В течение 3 дней",
        action: "Подтвердить альтернативных поставщиков, сроки переключения и возможное удорожание закупки.",
        expectedEffect: "Готовый план переключения закроет возможный операционный разрыв при прекращении поставок.",
      },
      {
        stage: "Проверка Норма",
        action: "Проверить совпадения по учредителям, руководителям и адресам, даты смены собственников и наличие других действующих контрагентов, связанных с той же группой владельцев.",
        expectedEffect: "Подтвердит или опровергнет версию согласованного вывода активов и выявит других контрагентов под тем же риском.",
      },
    ],
    checkpoint: {
      condition: "По одному из трёх поставщиков подтверждается смена собственников незадолго до банкротства и связь с другими действующими контрагентами.",
      response: "Эскалировать ситуацию владельцу риска, инициировать иски и расширить проверку на связанных контрагентов.",
    },
    clarification: "Номенклатура продукции трёх поставщиков, критичность позиций, складские остатки и подтверждённые сроки перехода на альтернативных контрагентов.",
    clarificationValue: "Эти данные позволят оценить объём операционного разрыва и выбрать приоритеты переключения. Подготовка исков не должна ждать этого расчёта.",
    clarificationChatQuestion: "Хочу уточнить номенклатуру, критичность позиций и складские остатки по трём поставщикам-банкротам",
    related: [
      "риск «Нарушение непрерывности поставок»",
      "три записи о банкротстве за 4 часа",
      "три договора на 84 млн ₽",
      "смена собственников у двух поставщиков",
    ],
    riskId: "QNR-0214",
    relatedOther: [
      "Реестр банкротств · 3 записи за 4 часа",
      "Договоры · 3 контракта · 84 млн ₽",
      "Связи контрагентов · смена собственников",
    ],
    sourceIds: ["fp-supply-s0", "fp-supply-s1", "fp-supply-s2", "fp-supply-s3"],
    primaryAction: "Начать подготовку исков",
    secondaryActions: ["Подтвердить альтернативных поставщиков", "Проверить связи между контрагентами", "Обсудить с Нормом"],
    chatQuestion: "Помоги с планом действий по трём поставщикам, попавшим в реестр банкротств",
    signalDate: "22 июля 2026",
  },
  {
    id: "fp-it",
...
const FOCUS_POINT_SOURCES: Record<string, FocusSource> = {
  ...
  "fp-supply-s0": { id: "fp-supply-s0", type: "Внешний реестр", title: "Записи о банкротстве трёх поставщиков", date: "22 июля 2026", excerpt: "Три поставщика внесены в реестр в 04:35, 06:12 и 07:50.", relation: "Подтверждает одновременное резкое ухудшение состояния трёх действующих контрагентов." },
  "fp-supply-s1": { id: "fp-supply-s1", type: "Договоры", title: "Договоры с проблемными поставщиками", date: "актуально на 22 июля 2026", excerpt: "Под угрозой неисполнения находятся три договора на общую сумму 84 млн ₽.", relation: "Определяет непосредственный объём договорных обязательств под угрозой." },
  "fp-supply-s2": { id: "fp-supply-s2", type: "Профиль компании", title: "Собственники и связи контрагентов", excerpt: "У двух поставщиков сменились собственники незадолго до банкротства; между контрагентами обнаружены связи.", relation: "Даёт основание проверить версию согласованного вывода активов." },
  "fp-supply-s3": { id: "fp-supply-s3", type: "Реестр рисков", title: "QNR-0214 · Нарушение непрерывности поставок", excerpt: "Одновременная несостоятельность нескольких поставщиков создаёт угрозу прекращения поставок.", relation: "Связывает контрагентский сигнал с корпоративным операционным риском." },
...
const GAP_SOURCES: Record<string, FocusSource> = {
  ...
  "gap-suppliers": {
    id: "gap-suppliers",
    type: "Состояние знаний",
    title: "Номенклатура и замена трёх проблемных поставщиков",
    excerpt:
      "Норму не хватает номенклатуры продукции трёх проблемных поставщиков, критичности позиций, складских остатков и подтверждённых сроков перехода на альтернативных контрагентов.",
    relation:
      "Без этих данных нельзя точно рассчитать объём операционного разрыва при прекращении поставок и приоритеты переключения.",
  },
  "gap-customers": {
    id: "gap-customers",
    type: "Состояние знаний",
...
const COMPANY_SUMMARY: CompanySummary = {
  ...
  leadBullets: [
    ...
    {
      tone: "orange",
      title: "Возможен подготовленный вывод активов",
      text: "У двух из трёх поставщиков незадолго до банкротства сменились собственники. Нужно готовить иски и параллельно подтверждать альтернативных поставщиков.",
    },
    {
      tone: "orange",
      title: "Запуск AI-продукта под риском из-за дефицита GPU",
      text: "Внутренний отчёт фиксирует нехватку мощностей. Подтверждённого плана расширения пока нет.",
    },
    {
      tone: "blue",
      title: "Фоновые сигналы",
      text: "Есть признаки возможного оттока клиентов — проверяем. По ИТ-сбоям динамика положительная — продолжаем наблюдать.",
    },
  ],
  requiredDecision:
  ...
  sections: [
    {
      ...
      title: "Решить сейчас",
      tone: "orange",
      headline: "Три поставщика на грани дефолта — нужны иски и переключение",
      text: "За четыре часа три поставщика внесены в реестр банкротств. Под угрозой три договора на 84 млн ₽, срыв поставок вероятен в ближайшие недели. У двух из трёх поставщиков незадолго до банкротства сменились собственники — сочетание сигналов и связи между контрагентами могут указывать на подготовленный вывод активов.",
      shortText:
        "Три поставщика — банкротство за 4 часа. Три договора на 84 млн ₽ под угрозой.",
      ...
      sources: [
        {
          ...
          label: "Записи о банкротстве",
          supportedClaim:
            "Три поставщика внесены в реестр банкротств в 04:35, 06:12 и 07:50.",
        },
        {
          sourceId: "fp-supply-s1",
          label: "Договоры",
          supportedClaim:
            "Под угрозой неисполнения три действующих договора на общую сумму 84 млн ₽.",
        },
        {
          sourceId: "fp-supply-s2",
          label: "Профиль · Связи контрагентов",
          supportedClaim:
            "У двух поставщиков сменились собственники незадолго до банкротства; между контрагентами обнаружены связи.",
        },
        {
          sourceId: "fp-supply-s3",
          label: "Риск QNR-0214",
          supportedClaim:
            "Одновременная несостоятельность нескольких поставщиков создаёт угрозу прекращения поставок.",
        },
      ],
...
function AssistantModal({ initialQuery, onClose, onToast }: { initialQuery: string | null; onClose: () => void; onToast: (m: string) => void; }) {
  ...
  async function runSituationDiscussion() {
    ...
    push({
      ...
      rich: (
        <>
          <p>Сейчас больше всего внимания требуют контрагенты: три поставщика за четыре часа попали в реестр банкротств, под угрозой три договора на 84 млн ₽. Параллельно стоит проверить возможный отток клиентов и продолжить наблюдение за новой ИТ-мерой.</p>
          <p>С чего начнём?</p>
        </>
      ),
    });
    push({
      role: "actions",
      actions: [
        { label: "Разобрать ситуацию с поставщиками", onClick: () => continueDialog("Разобрать ситуацию с поставщиками") },
  ...
  async function runSummarySupplies() {
    setBusy(true);
    push({ role: "status", text: "Смотрю ситуацию с поставщиками" });
    await wait(700);
    removeStatus();
    push({
      role: "assistant",
      rich: (
        <>
          <p>Три поставщика внесены в реестр банкротств за четыре часа. Под угрозой неисполнения три договора на общую сумму 84 млн ₽. У двух из трёх поставщиков незадолго до банкротства сменились собственники — возможен согласованный вывод активов.</p>
          <p>В первую очередь стоит инициировать подготовку исков и параллельно подтвердить альтернативных поставщиков, чтобы закрыть возможный операционный разрыв.</p>
        </>
      ),
    });
    setBusy(false);
